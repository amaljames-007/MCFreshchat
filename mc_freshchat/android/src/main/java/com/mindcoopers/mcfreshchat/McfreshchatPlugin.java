package com.mindcoopers.mcfreshchat;
...
/** FreshchatPlugin */
public class McfreshchatPlugin implements MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "mcfreshchat");
    channel.setMethodCallHandler(new McfreshchatPlugin((Application) registrar.context()));
  }

  private McfreshchatPlugin(Application application) {
